				...
				<?php while ( have_posts() ) : the_post(); ?>
						...
						<div class="product-box grid_3" style="border:solid;width:400px;">
							<div class="pricebar cf" style="width:400px;text-align:center;"> 
								<center><h2 style="width:'400px';text-align:'center';color:<?php warna(get_post_meta($post->Title)); ?>;"><a href="<?php the_permalink(); ?>" style="color:<?php warna(get_post_meta($post->Title)); ?>;"><?php the_title(); ?></a></h2></center>
