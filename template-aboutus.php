	...
	<div id="primary" class="content-area container_12">
		<div id="article-area" class="cf">
			<div style="margin-left:20px;float:left;margin-right:20px;">
				<img src="<?php echo get_template_directory_uri(); ?>/images/aboutus.jpg" width="600px" height="400">
			</div>
			<div>
				<p style="margin-left:20px;text-align:left;text-align:justify;">
		...
		<p style="text-align:center; margin-left:10px;margin-top:45px;">
